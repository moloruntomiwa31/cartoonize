<template>
    <main class="flex flex-col justify-center items-center p-6 mt-12">
        <div class="hero flex flex-col text-center space-y-10 md:w-[60%] lg:w-[60%]">
            <h1 class="text-black font-bold text-4xl md:text-5xl">A creative tool so simple, a toddler could use it.</h1>
            <p class="text-gray-500">Our all-in-one creative platform helps you achieve professional and stunning results
            ...
            <div class="w-full">
                <video src="https://www.cartoonize.net/wp-content/uploads/2022/06/features-hero.mp4?_=1" autoplay loop></video>
            </div>
            <div class="flex flex-col space-y-6">
                <div class="flex justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 15 15">
                ...
                <div><a href="" class="text-orange-500 w-fit border-b-2 border-orange-500 text-2xl font-bold">Start editing now ></a></div>
            </div>
        </div>
    </main>
    <FeatureCard />
