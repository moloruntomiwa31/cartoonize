...
const effectTab = ref([
    ...
    {
        icon: icon3,
        title: "Over 4 million photos, graphics & icons",
        description: "Choose from the most extensive library of high-resolution stock photography, premium vector graphics, and diverse icon sets.",
